package ermaster.editor.controller.editpolicy.element.node.table_view;
...
import ermaster.editor.controller.command.diagram_contents.element.node.table_view.AddColumnGroupCommand;
import ermaster.editor.controller.command.diagram_contents.element.node.table_view.AddWordCommand;
import ermaster.editor.controller.command.diagram_contents.element.node.table_view.ChangeColumnOrderCommand;
...
import ermaster.editor.model.diagram_contents.element.node.table.column.CopyColumn;
import ermaster.editor.model.diagram_contents.element.node.table.column.NormalColumn;
import ermaster.editor.model.diagram_contents.not_element.dictionary.CopyWord;
