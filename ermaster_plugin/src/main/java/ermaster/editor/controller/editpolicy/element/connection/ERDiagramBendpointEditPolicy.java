...
import ermaster.editor.controller.command.diagram_contents.element.connection.bendpoint.CreateBendpointCommand;
import ermaster.editor.controller.command.diagram_contents.element.connection.bendpoint.DeleteBendpointCommand;
