package ermaster.editor.controller.editpolicy.element.node;
...
import ermaster.editor.controller.command.diagram_contents.element.connection.relation.AbstractCreateRelationCommand;
...
import ermaster.editor.controller.command.diagram_contents.element.connection.relation.ReconnectSourceCommand;
import ermaster.editor.controller.command.diagram_contents.element.connection.relation.ReconnectTargetCommand;
...
import ermaster.editor.controller.editpart.element.node.TableViewEditPart;
...
import ermaster.editor.model.diagram_contents.element.connection.RelatedTable;
import ermaster.editor.model.diagram_contents.element.connection.Relation;
import ermaster.editor.model.diagram_contents.element.connection.RelationByExistingColumns;
import ermaster.editor.model.diagram_contents.element.connection.SelfRelation;
