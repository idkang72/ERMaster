...
import ermaster.editor.controller.command.diagram_contents.element.node.DeleteElementCommand;
import ermaster.editor.controller.command.diagram_contents.element.node.category.DeleteCategoryCommand;
