package ermaster.editor.controller.editpolicy;
...
import ermaster.editor.controller.command.NothingToDoCommand;
import ermaster.editor.controller.command.diagram_contents.element.connection.bendpoint.MoveBendpointCommand;
import ermaster.editor.controller.command.diagram_contents.element.node.CreateElementCommand;
import ermaster.editor.controller.command.diagram_contents.element.node.MoveElementCommand;
import ermaster.editor.controller.command.diagram_contents.element.node.category.MoveCategoryCommand;
...
import ermaster.editor.controller.editpolicy.element.node.NodeElementSelectionEditPolicy;
