...
import ermaster.editor.controller.command.diagram_contents.not_element.dictionary.EditWordCommand;
...
import ermaster.editor.view.dialog.word.word.WordDialog;
