...
import ermaster.editor.controller.editpart.element.ERDiagramEditPartFactory;
import ermaster.editor.controller.editpart.element.PagableFreeformRootEditPart;
import ermaster.editor.model.ERDiagram;
import ermaster.editor.view.ERDiagramPopupMenuManager;
...
import ermaster.editor.view.action.dbexport.ExportToDBAction;
...
import ermaster.editor.view.action.edit.ChangeBackgroundColorAction;
import ermaster.editor.view.action.edit.CopyAction;
import ermaster.editor.view.action.edit.DeleteWithoutUpdateAction;
import ermaster.editor.view.action.edit.EditAllAttributesAction;
import ermaster.editor.view.action.edit.PasteAction;
import ermaster.editor.view.action.edit.SelectAllContentsAction;
import ermaster.editor.view.action.group.GroupManageAction;
import ermaster.editor.view.action.line.AutoResizeModelAction;
import ermaster.editor.view.action.line.DefaultLineAction;
import ermaster.editor.view.action.line.ERDiagramAlignmentAction;
import ermaster.editor.view.action.line.ERDiagramMatchHeightAction;
import ermaster.editor.view.action.line.ERDiagramMatchWidthAction;
import ermaster.editor.view.action.line.HorizontalLineAction;
import ermaster.editor.view.action.line.RightAngleLineAction;
import ermaster.editor.view.action.line.VerticalLineAction;
...
import ermaster.editor.view.action.option.notation.LockEditAction;
import ermaster.editor.view.action.option.notation.TooltipAction;
...
import ermaster.editor.view.action.printer.PrintImageAction;
...
import ermaster.editor.view.action.zoom.ZoomAdjustAction;
import ermaster.editor.view.contributor.ERDiagramActionBarContributor;
import ermaster.editor.view.drag_drop.ERDiagramTransferDragSourceListener;
import ermaster.editor.view.drag_drop.ERDiagramTransferDropTargetListener;
import ermaster.editor.view.outline.ERDiagramOutlinePage;
import ermaster.editor.view.outline.ERDiagramOutlinePopupMenuManager;
import ermaster.editor.view.tool.ERDiagramPaletteRoot;
import ermaster.extention.ExtensionLoader;
