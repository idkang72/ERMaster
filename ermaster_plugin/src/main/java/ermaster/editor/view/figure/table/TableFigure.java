package ermaster.editor.view.figure.table;
...
import ermaster.editor.view.figure.table.column.GroupColumnFigure;
import ermaster.editor.view.figure.table.column.NormalColumnFigure;
import ermaster.editor.view.figure.table.style.StyleSupport;
import ermaster.editor.view.figure.table.style.frame.FrameStyleSupport;
import ermaster.editor.view.figure.table.style.funny.FunnyStyleSupport;
import ermaster.editor.view.figure.table.style.simple.SimpleStyleSupport;
