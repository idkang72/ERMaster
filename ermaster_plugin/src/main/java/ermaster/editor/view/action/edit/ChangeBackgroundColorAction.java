...
import ermaster.editor.controller.command.display.ChangeBackgroundColorCommand;
import ermaster.editor.controller.command.display.ChangeConnectionColorCommand;
