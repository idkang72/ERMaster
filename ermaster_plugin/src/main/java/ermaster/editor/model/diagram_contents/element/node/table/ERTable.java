package ermaster.editor.model.diagram_contents.element.node.table;
...
import ermaster.editor.model.diagram_contents.element.node.table.column.ColumnHolder;
import ermaster.editor.model.diagram_contents.element.node.table.column.NormalColumn;
import ermaster.editor.model.diagram_contents.element.node.table.index.CopyIndex;
...
import ermaster.editor.model.diagram_contents.element.node.table.properties.TablePropertiesHolder;
import ermaster.editor.model.diagram_contents.element.node.table.properties.TableViewProperties;
import ermaster.editor.model.diagram_contents.element.node.table.unique_key.ComplexUniqueKey;
import ermaster.editor.model.diagram_contents.element.node.table.unique_key.CopyComplexUniqueKey;
