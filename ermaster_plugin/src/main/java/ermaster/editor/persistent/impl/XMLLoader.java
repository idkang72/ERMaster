...
import ermaster.db.impl.oracle.tablespace.OracleTablespaceProperties;
import ermaster.db.impl.postgres.PostgresDBManager;
import ermaster.db.impl.postgres.PostgresTableProperties;
...
import ermaster.editor.model.dbexport.ddl.DDLTarget;
...
import ermaster.editor.model.diagram_contents.element.node.table.unique_key.ComplexUniqueKey;
import ermaster.editor.model.diagram_contents.element.node.view.View;
import ermaster.editor.model.diagram_contents.element.node.view.properties.ViewProperties;
import ermaster.editor.model.diagram_contents.not_element.dictionary.Dictionary;
import ermaster.editor.model.diagram_contents.not_element.dictionary.TypeData;
import ermaster.editor.model.diagram_contents.not_element.dictionary.UniqueWordDictionary;
...
import ermaster.editor.model.settings.EnvironmentSetting;
...
import ermaster.editor.model.settings.TranslationSetting;
import ermaster.editor.model.settings.export.ExportDDLSetting;
...
public class XMLLoader {
	...
	private void load(Element root) {
		...
		int categoryIndex = this.getIntValue(root, "category_index");
